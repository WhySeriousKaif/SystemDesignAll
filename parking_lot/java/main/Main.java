package parking_lot.java.main;

import parking_lot.java.gates.EntranceGate;
import parking_lot.java.gates.ExitGate;
import parking_lot.java.parkinglot.ParkingFloor;
import parking_lot.java.parkinglot.ParkingLot;
import parking_lot.java.payments.PaymentService;
...
public class Main {
    public static void main(String[] args) {
        ...
        EntranceGate entranceGate = new EntranceGate(parkingLot, scanner);
